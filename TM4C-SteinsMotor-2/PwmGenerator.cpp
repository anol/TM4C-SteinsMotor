...
const PwmConfiguration Configurations[] =
{
    ...
    {   "PD0", SYSCTL_PERIPH_PWM1, SYSCTL_PERIPH_GPIOD, GPIO_PD0_M1PWM0, GPIO_PORTD_BASE, GPIO_PIN_0, PWM1_BASE, PWM_GEN_0, PWM_OUT_0_BIT},
    {   "PD1", SYSCTL_PERIPH_PWM1, SYSCTL_PERIPH_GPIOD, GPIO_PD1_M1PWM1, GPIO_PORTD_BASE, GPIO_PIN_1, PWM1_BASE, PWM_GEN_0, PWM_OUT_1_BIT},
    {   "PB6", SYSCTL_PERIPH_PWM0, SYSCTL_PERIPH_GPIOB, GPIO_PB6_M0PWM0, GPIO_PORTB_BASE, GPIO_PIN_6, PWM0_BASE, PWM_GEN_3, PWM_OUT_6_BIT},
    {   "PB7", SYSCTL_PERIPH_PWM0, SYSCTL_PERIPH_GPIOB, GPIO_PB7_M0PWM1, GPIO_PORTB_BASE, GPIO_PIN_7, PWM0_BASE, PWM_GEN_3, PWM_OUT_7_BIT}};
